            ...
            <div className="zeta-card mb-8">
              <div className="prose prose-lg max-w-none text-yakusa-text">
                ...
                <section className="mb-8">
                  ...
                  <div className="bg-yakusa-bg-sub p-6 rounded-lg">
                    <p className="text-lg font-medium text-yakusa-text mb-2">八雷神</p>
                    <p className="text-yakusa-text-light">東京都港区白金</p>
                    <p className="text-yakusa-text-light">メール: contact@8ikazuchi.jp</p>
                  </div>
                </section>
