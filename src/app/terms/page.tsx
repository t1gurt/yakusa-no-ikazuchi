...
export default function Terms() {
  return (
    <main>
      <Navigation />
      <div className="pt-24 pb-16 bg-yakusa-bg-main min-h-screen">
        <div className="zeta-container">
          <div className="max-w-4xl mx-auto">
            {/* ヘッダー */}
            <div className="mb-16 text-center">
              <h1 className="text-5xl md:text-6xl font-light text-yakusa-text mb-6 tracking-wider">
                利用規約
              </h1>
              <p className="text-xl text-yakusa-text-light font-light">
                八雷神のサービス利用に関する規約
              </p>
            </div>

            {/* コンテンツ */}
            <div className="zeta-card mb-8">
              <div className="prose prose-lg max-w-none text-yakusa-text">
                <section className="mb-12">
                  <h2 className="text-3xl font-medium mb-6 text-yakusa-text tracking-wide">
                    第1条（適用）
                  </h2>
                  <p className="text-lg leading-relaxed text-yakusa-text-light">
                    この利用規約（以下「本規約」 ）は、八雷神（以下「当団体」 ）が提供するサービス（以下「本サービス」 ）の利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」 ）には、本規約に従って、本サービスをご利用いただきます。
                  </p>
                </section>
                ...
                <section className="mb-12">
                  ...
                  <div className="space-y-4">
                    <p className="text-lg leading-relaxed text-yakusa-text-light">
                      1. 本サービスにおいて、登録希望者が当団体の定める方法によって利用登録を申請し、当団体がこれを承認することによって、利用登録が完了するものとします。
                    </p>
                    <p className="text-lg leading-relaxed text-yakusa-text-light">
                      2. 当団体は、利用登録の申請者に以下の事由があると判断した場合、利用登録の申請を承認しないことがあり、その理由については一切の開示義務を負わないものとします。
                    </p>
                    <ul className="list-disc pl-6 mt-4 space-y-2 text-yakusa-text-light">
                ...
                <section className="mb-12">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-lg leading-relaxed text-yakusa-text-light">
                      3. 当団体は、ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には、そのユーザーIDを登録しているユーザー自身による利用とみなします。
                    </p>
                  </div>
                </section>
                ...
                <section className="mb-12">
                  ...
                  <p className="text-lg leading-relaxed mb-4 text-yakusa-text-light">
                    ユーザーは、本サービスの利用にあたり、以下の行為をしてはなりません。
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-yakusa-text-light">
                ...
                <div className="text-center pt-8 border-t border-yakusa-text/15">
                  <p className="text-yakusa-text-muted">
                    制定日：2025年6月16日
                  </p>
                </div>
              </div>
