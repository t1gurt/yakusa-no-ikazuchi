...
export function About() {
  return (    <section id="about" className="zeta-section bg-white">
      <div className="zeta-container">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="zeta-card bg-gray-50 border border-gray-200"
          >
            <h3 className="text-xl font-medium text-black mb-4 tracking-wider">
              混沌からの創造
            </h3>
